...
function [] = main()
    ...
    % For BlueRaven files: input as a vector [High rate data, Low rate data]
    [~, sourceList] = createSourceObject( ...
        ["rawData/BlueRaven_high_rate_02-01-2024_20_33" "rawData/BlueRaven_low_rate_02-01-2024_20_33"], ...
        "BlueRaven", ...
        "BlueRaven data", ...
        sourceList);
